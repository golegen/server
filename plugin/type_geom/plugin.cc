...
static ST_SCHEMA_TABLE spatial_ref_sys=
{
  "SPATIAL_REF_SYS",                        // table_name
  spatial_ref_sys_fields_info,              // fields_info
  0,                                        // reset_table
  spatial_ref_sys_fill,                     // fill_table
  NULL,                                     // old_format
  NULL,                                     // process_table
  -1,                                       // idx_field1
  -1,                                       // idx_field2
  0,                                        // hidden
  0                                         // i_s_requested_object
};


static int fill_table_spatial_ref_sys(THD* thd, TABLE_LIST* tables, COND* cond)
{
  tables->schema_table= &spatial_ref_sys,
